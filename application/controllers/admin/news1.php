...
class News1 extends CI_Controller{
    ...
    public function index(){
        ...
        $this->data["tot_row"]          = $this->m_news1->selectNews1Count();
        ...
        $this->data["result"]           = $this->m_news1->selectNews1();
        $this->load->view('admin/news1/index',$this->data);
    }
    ...
    public function regist(){
        ...
        $result                             = $this->m_news1->selectNews1One($BC_SEQ);
        ...
        $this->load->view('admin/news1/regist', $this->data);
    }
    ...
    public function registProcess(){
        ...
        if($BC_SEQ == ""){
            ...
            $this->result                   = $this->m_news1->insertProcess($data);
        }else{
            $this->result                   = $this->m_news1->updateProcess($data, $BC_SEQ);
        }
    ...
    public function deleteProcess(){
        ...
        if($BC_SEQ != ""){
            $result                         = $this->m_news1->deleteProcess($BC_SEQ);
