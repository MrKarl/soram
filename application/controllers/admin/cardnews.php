...
class Cardnews extends CI_Controller{
    ...
    public function __construct(){
        ...
        $this->load->model('admin/m_cardnews');
    ...
    public function index(){
        ...
        $this->data["tot_row"]          = $this->m_cardnews->selectCardnewsCount();
        ...
        $this->data["result"]           = $this->m_cardnews->selectCardnews();
        $this->load->view('admin/cardnews/index',$this->data);
    }
    ...
    public function regist(){
        ...
        $result                             = $this->m_cardnews->selectCardnewsOne($BC_SEQ);
        ...
        $this->load->view('admin/cardnews/regist', $this->data);
    }
    ...
    public function registProcess(){
        ...
        if($BC_SEQ == ""){
            ...
            $this->result                   = $this->m_cardnews->insertProcess($data);
        }else{
            $this->result                   = $this->m_cardnews->updateProcess($data, $BC_SEQ);
        }
    ...
    public function deleteProcess(){
        ...
        if($BC_SEQ != ""){
            $result                         = $this->m_cardnews->deleteProcess($BC_SEQ);
