...
<section class="center_wrap">
    <div class="center_wrap_inner">
        ...
        <div class="tab_menu_wrap tab_menu_st2">
            <ul>
                <li><a href="/guide/notice">공지사항</a></li>
                <li class="on"><a href="javascript:tab_click('tab2_cont');">소람이야기</a></li>
            </ul>
        </div>
        <!--소람이야기 view tab_cont-->
        <div class="tab_cont tab1_cont">
            <div class="viewpage_wrap mt40 ">
                <div class="title_box">
                    <p class="title"><?=$result->ST_TTL?></p>
                    <p class="w_date f_roboto"><?=substr($result->ST_RGST_YMDT,0,10)?></p>
                </div>
                <!--비디오영역-->
                <?if($result->ST_VOD_MP4):?>
                <div class="video_wrap mt40">
                    <video  width="100%" height="100%">
                        <source type="video/mp4" src="<?=$result->ST_VOD_MP4?>" />
                        <object width="540" height="304" type="application/x-shockwave-flash" data="video/flashmediaelement.swf">
                            ...
                            <param name="flashvars" value="controls=true&amp;file=<?=$result->ST_VOD_MP4?>" />
                ...
                <?endif;?>
                <!--//비디오영역-->
                <div class="view_cont"><?=$result->ST_CONT?>
                </div>
                <div class="btn_line mt20">
                    <a href="/guide/story" class="btn_list f_roboto">LIST</a>
                    <div class="page_navi">
                        <?if($preview != ""):?>
                        <a href="/guide/story_view?seq=<?=$preview?>" class="bt_prev">이전</a>
                        <?endif;?>
                        <?if($next != ""):?>
                        <a href="/guide/story_view?seq=<?=$next?>" class="bt_next">다음</a>
                        <?endif;?>
                    </div>
                </div>
            </div>
