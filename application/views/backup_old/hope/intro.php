<script type="text/javascript">
    $(document).ready(function($){
        ...
        var area = '<?=$this->input->get_post('area')?>';
...
<div class="quick_wrap">
    <ul>
        <li><a href="#area1" id="scroll_area1" class="scroll">area1</a></li>
        <li><a href="#area2" id="scroll_area2" class="scroll">area2</a></li>
        <li><a href="#area3" id="scroll_area3" class="scroll">area3</a></li>
        <li><a href="#area4" id="scroll_area4" class="scroll">area4</a></li>
        <li><a href="#area5" id="scroll_area5" class="scroll">area5</a></li>
    </ul>
</div>
<!--//quick_wrap -->
<!--center_wrap -->
...
<section class="right_wrap" id="area0">
    <div class="right_wrap_inner2" >
        <div class="case_intro">
            <!--location -->
            <div class="location">
                <a href="/"><span class="home"></span></a><a href="#">희망 메시지</a>
            </div>
            <h3>희망 메시지</h3>
            <div class="case_box_wrap" id="area1">
                <!--동영상1-->
                <!--
                	movie_wrap4 div에 st_video 클래스가 있으면 position이 absolute로 잡혀서 이미지가 겹치게 보임(주석처리함 - 2016.10.10)
                -->
                <div class="movie_wrap4 <!--<?=( $media_result[0]['v_type'] == "1" ) ? "st_video" : ""?>-->">
                    ...
                    <?if($media_result[0]['v_type'] == "1"):?>
                        <div class="video_wrap2">
                            <video  width="100%" height="100%" id="video1" poster="/public/upload/image/video_cover/01_hope_sub.jpg">
                ...
                <div class="case_box case_lung" >
                    ...
                    <div class="btn_line mt80">
                    	<?
                    	if ($this->session->userdata("MBR_ID") == "")
                    	{
                    	?>
                    		<a href="javascript:loginPopup('/hope/lung');" class="bt_st2">폐암 희망메세지 더보기</a>
                    	<?
                    	} else {
                    	?>
                    		<a href="/hope/lung" class="bt_st2">폐암 희망메세지 더보기</a>
                    	<?
                    	}
                    	?>
                    </div>
            ...
            <div class="case_box_wrap" id="area2">
                ...
                <div class="movie_wrap4 <!--<?=( $media_result[1]['v_type'] == "1" ) ? "st_video" : ""?>-->">
                	...
                	?>
                		<div class="img_hope_center" >
                            <a href="javascript:loginPopup();"><img src="/public/upload/image/video_cover/02_hope.jpg" /></a>
                        </div>
                	<?
                	} else {
                	?>
                    ...
                    <?if($media_result[1]['v_type'] == "1"):?>
                        <div class="video_wrap2">
                            <video  width="100%" height="100%" id="video2" poster="/public/upload/image/video_cover/02_hope_sub.jpg" >
                ...
                <div class="case_box case_breast" >
                    ...
                    <div class="btn_line mt80">
                    	...
                    	{
                    	?>
                    		<a href="javascript:loginPopup('/hope/breast');" class="bt_st2">유방암 희망메세지 더보기</a>
                    	<?
                    	} else {
                    	?>
                    		<a href="/hope/breast" class="bt_st2">유방암 희망메세지 더보기</a>
                    	<?
                    	}
                    	?>
                    </div>
            ...
            <div class="case_box_wrap" id="area3">
                ...
                <div class="movie_wrap4 <!--<?=( $media_result[2]['v_type'] == "1" ) ? "st_video" : ""?>-->">
                	...
                	?>
                		<div class="img_hope_center" >
                            <a href="javascript:loginPopup();"><img src="/public/upload/image/video_cover/03_hope.jpg" /></a>
                        </div>
                	<?
                	} else {
                	?>
                    ...
                    <?if($media_result[2]['v_type'] == "1"):?>
                        <div class="video_wrap2">
                            <video  width="100%" height="100%" id="video3"  poster="/public/upload/image/video_cover/03_hope_sub.jpg">
                ...
                <div class="case_box case_colorectal" >
                    ...
                    <div class="btn_line mt80">
                    	...
                    	{
                    	?>
                    		<a href="javascript:loginPopup('/hope/colorectal');" class="bt_st2">대장암 희망메세지 더보기</a>
                    	<?
                    	} else {
                    	?>
                    		<a href="/hope/colorectal" class="bt_st2">대장암 희망메세지 더보기</a>
                    	<?
                    	}
                    	?>
                    </div>
            ...
            <div class="case_box_wrap" id="area4">
                ...
                <div class="movie_wrap4 <!--<?=( $media_result[3]['v_type'] == "1" ) ? "st_video" : ""?>-->">
                    ...
                    <?if($media_result[3]['v_type'] == "1"):?>
                        <div class="video_wrap2">
                            <video  width="100%" height="100%" id="video4"  poster="/public/upload/image/video_cover/04_hope_sub.jpg">
                ...
                <div class="case_box case_liver" >
                    ...
                    <div class="btn_line mt80">
                    	...
                    	{
                    	?>
                    		<a href="javascript:loginPopup('/hope/liver');" class="bt_st2">간,담,췌장암 희망메세지 더보기</a>
                    	<?
                    	} else {
                    	?>
                    		<a href="/hope/liver" class="bt_st2">간,담,췌장암 희망메세지 더보기</a>
                    	<?
                    	}
                    	?>
                    </div>
            ...
            <div class="case_box_wrap" id="area5">
                ...
                <div class="movie_wrap4 <!--<?=( $media_result[4]['v_type'] == "1" ) ? "st_video" : ""?>-->">
                	...
                	?>
                		<div class="img_hope_center" >
                            <a href="javascript:loginPopup();"><img src="/public/upload/image/video_cover/05_hope.jpg" /></a>
                        </div>
                	<?
                	} else {
                	?>
                    ...
                    <?if($media_result[4]['v_type'] == "1"):?>
                        <div class="video_wrap2">
                            <video  width="100%" height="100%" id="video5"  poster="/public/upload/image/video_cover/05_hope_sub.jpg">
                ...
                <div class="case_box case_brain" >
                    ...
                    <div class="btn_line mt80">
                    	...
                    	{
                    	?>
                    		<a href="javascript:loginPopup('/hope/etc');" class="bt_st2">기타암 희망메세지 더보기</a>
                    	<?
                    	} else {
                    	?>
                    		<a href="/hope/etc" class="bt_st2">기타암 희망메세지 더보기</a>
                    	<?
                    	}
                    	?>
                    </div>
