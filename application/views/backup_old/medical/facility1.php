...
<section class="right_wrap st_heal">
    <div class="right_wrap_inner">
        ...
        <div class="tab_menu_wrap ">
            <ul>
                <li class="on"><a href="/medical/facility?type=1" >입원실</a></li>
        ...
        <div class="txt_box2 mt40">소람한방병원에는 암 환자 전용 1인실, 4인실 입원실을 갖추고 있습니다. 입원실에 계신 환자분들은
            소람의 입원 치료 프로그램에 따라 맞춤 처방 및 치료를 받으실 수 있습니다. </div>
        <!--입원실-->
        <div class="tab_cont tab1_cont ">
            <div class="slide_wrap mt40">
                <ul class="tab1_cont_gallay">
                    <li><img src="/public/front/images/intro/img_part1_gallary_01.jpg" alr="" /></li>
                    <li><img src="/public/front/images/intro/img_part1_gallary_02.jpg" alr="" /></li>
                    <li><img src="/public/front/images/intro/img_part1_gallary_03.jpg" alr="" /></li>
                    <li><img src="/public/front/images/intro/img_part1_gallary_04.jpg" alr="" /></li>
                </ul>
                <div id="bx-pager1" class="thumb_list">
                    <a data-slide-index="0" href=""><img src="/public/front/images/intro/img_part1_gallary_01.jpg" /></a>
                    <a data-slide-index="1" href=""><img src="/public/front/images/intro/img_part1_gallary_02.jpg" /></a>
                    <a data-slide-index="2" href=""><img src="/public/front/images/intro/img_part1_gallary_03.jpg" /></a>
                    <a data-slide-index="3" href=""><img src="/public/front/images/intro/img_part1_gallary_04.jpg" /></a>
                </div>
            </div>
        </div>
        <!--//입원실-->
