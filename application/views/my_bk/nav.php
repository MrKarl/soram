...
$(document).ready(function(){
	...
	$('body').click(function(e) {
		var $maskForHidingBody = $('<div class="maskForHidingBody">');
		var cssOfmaskForHidingBody = {
			'position':'absolute',
			'top':'0',
			'height':'100%',
			'width':'100%',
		...
		$maskForHidingBody.css(cssOfmaskForHidingBody);
		$('#wrap').after($maskForHidingBody);

		var $maskForHidingFooter = $('<div class="maskForHidingBody">');
		var cssOfmaskForHidingFooter = {
			'position':'absolute',
			'top':'0',
			'height':'100%',
			'width':'100%',
		...
		$maskForHidingFooter.css(cssOfmaskForHidingFooter);
		$('footer').after($maskForHidingFooter);
