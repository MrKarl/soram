    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
                    ...
                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                        ...
                        <?foreach($result as $rows):?>
                            <tr class="odd gradeX">
                                ...
                                <td class="text_center"><a href="/admin/notice/regist?NI_SEQ=<?=$rows["NI_SEQ"]?>"><?=$rows['NI_TTL']?></a></td>
                                <td class="text-center"><? if($rows["NI_EXPS_YN"] == "Y"){ ?><span class="label label-success">노출</span><? }else{ ?><span class="label label-danger">미노출</span><? } ?></td>
                                <td class="text-center"><?=$rows["NI_READ_CNT"]?></td>
                                <td class="text-center"><?=substr($rows["NI_RGST_YMDT"],0,10)?></td>
                            </tr>
                            <?$cur_num--?>
                            <?$row_cnt++;?>
                        <?endforeach?>
            ...
            <div class="panel-footer" style="height:55px;">
                <button type="button" class="btn btn-success pull-right" onclick="location.href='/admin/notice/regist'">등록</button>
            </div>
        </div>
        <!-- /.panel -->
