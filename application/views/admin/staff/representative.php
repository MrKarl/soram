...
<div class="row">
    <div class="col-lg-12">
        <h3 class="page-header">대표 의료진 관리 > <?=($type == "2") ? "한방대표원장" : "양방진료원장"?></h3>
        <div class="col-lg-4" style="margin-bottom: 10px; ">
            <div class="row">
                <label for="ticket-email" class="col-sm-4 control-label text-center" style="width:40px;"><h5 class="h5" style="width: 30px;"><strong>구분</strong></h5></label>
                <div class="col-lg-4">
                    <select class="form-control" id="type" onchange="changeType(this.value);">
                        <option value="2" <?=($type == "2") ? "selected" : ""?>>한방대표원장</option>
                        <option value="3" <?=($type == "3") ? "selected" : ""?>>양방진료원장</option>
                    </select>
                </div>
            </div>
        </div>
...
<script type="text/javascript">
    ...
    function changeType(type){
        location.href="/admin/staff/representative?type="+type;
        return;
    }
