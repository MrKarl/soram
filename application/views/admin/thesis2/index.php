...
<div class="row">
    <div class="col-lg-12">
        <h3 class="page-header">국제 / 국내 논문</h3>
    </div>
    <!-- /.col-lg-12 -->
</div>
    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
                    ...
                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                        ...
                        <?foreach($result as $rows):?>
                            <tr class="odd gradeX">
                                ...
                                <td class="text_center"><a href="/admin/thesis2/regist?idx=<?=$rows["idx"]?>"><?=$rows['title']?></a></td>
                                <td class="text-center"><?=$rows['writer']?></td>
                                <td class="text-center"><?=$rows['journal']?></td>
                                <td class="text-center"><? if($rows['USE_YN'] == "Y"){ ?><span class="label label-success">노출</span><? }else{ ?><span class="label label-info">미노출</span><? }?></td>
            ...
            <div class="panel-footer" style="height:55px;">
                <button type="button" class="btn btn-success pull-right" onclick="location.href='/admin/thesis2/regist'">등록</button>
            </div>
        </div>
        <!-- /.panel -->
