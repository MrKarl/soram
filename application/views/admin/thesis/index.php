    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
                    ...
                    <div class="dataTables_filter" style="display: inline-flex; float:right;">
                        ...
                        <label>
                            <select class="form-control input-sm" name="search_field" id="search_field" aria-controls="dataTables-example">
                                ...
                                <option value="writer" <?=($search_field == "writer") ? 'selected': ''?>>저자</option>
                    ...
                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                        <thead>
                            <tr>
                                ...
                                <th style="width:10%;" class="text-center">단체(학술지)</th>
                                <th style="width:10%;" class="text-center">파일</th>
                                <th style="width:10%;" class="text-center">노출여부</th>
                                <th style="width:10%;" class="text-center">논문발행일</th>
                        ...
                        <?foreach($result as $rows):?>
                            <tr class="odd gradeX">
                                ...
                                <td class="text_center"><a href="/admin/thesis/regist?idx=<?=$rows["idx"]?>"><?=$rows['title']?></a></td>
                                <td class="text-center"><?=$rows['writer']?></td>
                                <td class="text-center"><?=$rows['writerBook']?></td>
                                <td class="text-center"><?if($rows['PDFfile'] != ""){?><img src="/public/admin/images/ico/05_04_icon_pdf.png"/><?}if($rows['HWPfile'] != ""){?><img src="/public/admin/images/ico/05_04_icon_hwp.png"><?}if($rows['Wordfile'] != ""){?><img src="/public/admin/images/ico/05_04_icon_doc.png"><?}?></td>
                                <td class="text-center"><? if($rows['states'] == "Y"){ ?><span class="label label-success">노출</span><? }else{ ?><span class="label label-info">미노출</span><? }?></td>
                                <td class="text-center"><?=$rows['writerDate']?></td>
                                <td class="text-center"><?=$rows['readCount']?></td>
            ...
            <div class="panel-footer" style="height:55px;">
                <button type="button" class="btn btn-success pull-right" onclick="location.href='/admin/thesis/regist'">등록</button>
            </div>
        </div>
        <!-- /.panel -->
