    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
                    ...
                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                        ...
                        <?foreach($result as $rows):?>
                            <tr class="odd gradeX">
                                ...
                                <td class="text_center"><a href="/admin/hangam/regist?BC_SEQ=<?=$rows["BC_SEQ"]?>"><?=$rows['BC_TTL']?></a></td>
            ...
            <div class="panel-footer" style="height:55px;">
                <button type="button" class="btn btn-success pull-right" onclick="location.href='/admin/hangam/regist'">등록</button>
            </div>
        </div>
        <!-- /.panel -->
