...
<div class="row">
    <div class="col-lg-12">
        <h3 class="page-header">1:1상담 답변 설정</h3>
    </div>
    <!-- /.col-lg-12 -->
</div>
    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
                    ...
                    <div class="dataTables_filter" style="display: inline-flex; float:right;">
                        ...
                        <label>
                            <select class="form-control input-sm" name="search_field" id="search_field" aria-controls="dataTables-example">
                                ...
                                <option value="CA_TTL" <?=($search_field == "CA_TTL") ? 'selected': ''?>>제목</option>
                                <option value="CA_CONT" <?=($search_field == "CA_CONT") ? 'selected': ''?>>내용</option>
                            </select>
                        </label>
                    ...
                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                        ...
                        <?foreach($result as $rows):?>
                            <tr class="odd gradeX">
                                ...
                                <td class="text-center"><?=$rows["CA_SORD"]?></td>
                                <td class="text_center"><a href="/admin/adm_answer/regist?CA_SEQ=<?=$rows["CA_SEQ"]?>"><?=$rows['CA_TTL']?></a></td>
                                <td class="text-center"><?=substr($rows["CA_RGST_YMDT"],0,10)?></td>
                            </tr>
                            <?$cur_num--?>
                            <?$row_cnt++;?>
                        <?endforeach?>
            ...
            <div class="panel-footer" style="height:55px;">
                <button type="button" class="btn btn-success pull-right" onclick="location.href='/admin/adm_answer/regist';">등록</button>
            </div>
        </div>
        <!-- /.panel -->
